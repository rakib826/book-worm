...
const BookDetail = () => {
  ...
  const {image,author,bookName,category,review,tags,totalPages,yearOfPublishing,publisher,rating} = book;
    ...
    <div className='w-5/6 mx-auto mt-20'>
      <div className='flex flex-row justify-center w-5/6 mx-auto bg-gray-100 py-4 px-1 rounded-2xl'>
        <div className='w-1/2 mx-4 flex justify-center items-center'>
          <img className='w-full max-h-[663px] rounded-xl' src={image} alt={bookName} />
        </div>
        <div className='w-1/2 mx-4'>
          ...
          <div className='border-b-2 my-4'></div>
          <p className='my-4'> <span className='font-bold'>Review :</span> <span className='text-gray-500'>{review}</span> </p>
          ...
          <div className='flex flex-row'>
            <p className='w-1/2 font-semibold text-gray-500'>Number of Pages : </p>
          ...
          <div className='flex flex-row'>
            <p className='w-1/2 font-semibold text-gray-500'>Year of Publishing : </p>
          ...
          <div className='my-4'>
            <button className='py-2 px-4 border-2 border-lime-400 rounded'>Read</button>
            <button className='py-2 px-4 border-2 border-lime-500 bg-lime-500 ml-6 rounded'>Wishlist</button>
          </div>
        </div>
      </div>
    </div>
